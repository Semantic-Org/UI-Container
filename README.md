...
This repository contains pre-compiled container files using the default themes. This is intended for use in projects that do not need all the bells and whistles of Semantic UI, and want to keep file size to a minimum.

For the latest changes please see the [Release Notes](https://github.com/Semantic-Org/UI-Container/blob/master/RELEASE-NOTES.md)
...
```
bower install semantic-ui-container
```

#### To install with NPM
```
npm install semantic-ui-container
```

#### To install with Meteor
```
meteor add semantic:ui-container
```
